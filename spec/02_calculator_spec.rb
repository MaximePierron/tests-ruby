...
describe "#factorial" do
  ...
  it "requires positive integer" do
    expect(factorial(2.5)).to eq("factoriel ne s'applique qu'à des entiers positifs")
  end
  it "requires positive interger again" do
    expect(factorial(-2)).to eq("factoriel ne s'applique qu'à des entiers positifs")
  end
end
